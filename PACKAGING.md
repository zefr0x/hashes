...
3. Add a new `<release>` tag under the `<releases>` tag in the [`data/io.github.zefr0x.hash_identifier.metainfo.xml.in`](data/io.github.zefr0x.hash_identifier.metainfo.xml.in) file with information about the release and a link to the CHANGELOG file.
